              ...
              <div class="d-flex flex-column align-items-center text-center">
                ...
                <div class="mt-3">
                  <?php if ($_SESSION["view"] == "Member" || $_SESSION["view"] == "Panel") { ?>
                    ...
                    <h6 class="text-muted"><?php echo $_SESSION["joinedf"]; ?></h6>
          ...
          <div class="card mb-3 bg-dark text-light py-2 px-3">
            <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <?php if (!isset($_POST["add"])) { ?>
                        <form class="form-inline my-0 py-0" method="POST">
                          <button class="btn btn-secondary py-0 px-1" name="add">Add Fund</button>
                        </form>
                      <?php } else { ?>
                        <form class="form-inline my-0 py-0" action="selfupdate.php" method="POST">
                          <input type="number" class="form-inline text-center my-0 py-0 px-0 ml-3" name="amount" placeholder="Enter Amount" required>
                          <button class="btn btn-secondary my-0 py-0 px-1 ml-2" name="fund">Fund</button>
                          <a class="btn btn-light my-0 py-0 px-1 ml-2" href="profile.php">Cancel</a>
                        </form>
                      <?php } ?>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <?php if (!isset($_GET["add"])) { ?>
                        <form class="form-inline my-0 py-0" method="GET">
                          <button class="btn btn-secondary py-0 px-1" name="add">Add Fund</button>
                        </form>
                      <?php } else { ?>
                        <form class="form-inline my-0 py-0" action="selfupdate.php" method="POST">
                          <input type="number" class="form-inline text-center my-0 py-0 px-0 ml-3" name="amount" placeholder="Enter Fund Amount" required>
                          <button class="btn btn-secondary my-0 py-0 px-1 ml-2" name="fund">Fund</button>
                          <a class="btn btn-light my-0 py-0 px-1 ml-2" href="profile.php">Cancel</a>
                        </form>
                      <?php } ?>
              ...
              <?php if ($_SESSION["view"] != "Member") { ?>
                <div class="row">
                  <div class="col-sm-12">
                    <center><a class="btn btn-info" href="selfedit.php?warn=Editing Your Details">Edit Profile</a></center>
                  </div>
                </div>
              <?php } ?>
            </div>
